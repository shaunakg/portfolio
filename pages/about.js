...
const About = (props) => {
    ...
    return (
        ...
        <Head>
            ...
            <title>{`About | Shaunak G - Web Developer`}</title>
            <meta name="title" content={`About | Shaunak G - Web Developer`} />
            ...
            <meta property="og:title" content={`About | Shaunak G - Web Developer`} />
            ...
            <meta property="twitter:title" content={`About | Shaunak G - Web Developer`} />
